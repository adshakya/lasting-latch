(function ($) {
  ...
  function thmTestimonialsThumbCarousel() {
    if ($("#testimonials-one__thumb").length) {
      let testimonialsThumb = new Swiper("#expertise__thumb", {
        slidesPerView: 3,
        spaceBetween: 0,
        speed: 1400,
      ...
      let testimonialsCarousel = new Swiper("#expertise__carousel", {
        observer: true,
        observeParents: true,
        speed: 1400,
        mousewheel: true,
  ...
  $(window).on("scroll", function () {
    if ($(".stricked-menu").length) {
      ...
      if ($(window).scrollTop() > headerScrollPos) {
        stricky.addClass("stricky-header");
      } else if ($(this).scrollTop() <= headerScrollPos) {
        stricky.removeClass("stricky-header");
      }
    }
